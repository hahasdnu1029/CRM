										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>选择时间：</TD>
													<TD>
														<INPUT class=textbox id="beginDate" style="WIDTH: 80px" maxLength=50 name="beginDate" value="${beginDate }">
														<INPUT class=textbox id="endDate" style="WIDTH: 80px" maxLength=50 name="endDate" value="${ endDate }">
													</TD>
